...
const s = StyleSheet.create({
  ...
  card: { backgroundColor: colors.card, borderTopLeftRadius: 24, borderTopRightRadius: 24,
    padding: 32, alignItems: 'center', borderTopWidth: 1, borderColor: colors.border },
  ...
  barBg: { width: '100%', height: 6, backgroundColor: colors.border, borderRadius: 3, marginVertical: 20 },
