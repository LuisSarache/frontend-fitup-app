  ...
  return (
    ...
    <ScrollView contentContainerStyle={{ paddingBottom: 40 }} showsVerticalScrollIndicator={false}>
      <View style={[s.header, { paddingTop: insets.top + 16 }]}>
        ...
        <Text style={s.sub}>{achievements.length}/{ACHIEVEMENTS.length} desbloqueadas</Text>
        </View>
      </View>
...
const s = StyleSheet.create({
  ...
  streakCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.card, borderRadius: 16, padding: 18, marginHorizontal: 20, marginVertical: 16, borderWidth: 1, borderColor: colors.green, gap: 14 },
  ...
  card: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.card, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12, borderWidth: 1, borderColor: colors.green, gap: 14 },
